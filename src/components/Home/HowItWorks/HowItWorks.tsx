...
export default function HowItWorks() {
  ...
  return (
    <div className="w-full bg-white text-[#111111] font-poppins antialiased overflow-x-hidden flex flex-col items-center justify-center px-4 sm:px-6 md:px-8 select-none relative py-12 md:py-20">
